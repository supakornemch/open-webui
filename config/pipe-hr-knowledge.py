"""
title: Haadthip HR Knowledge (Pipe)
author: Haadthip
version: 1.0
required_open_webui_version: 0.1.0

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  Open WebUI Pipe — HR Documents (MiHCM)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Install in Open WebUI:
  ...
  Then select "Haadthip HR Knowledge (Pipe)" as the model
"""
...
class Pipe:
    ...
    def __init__(self):
        self.type = "pipe"
        self.id = "haadthip-hr-knowledge"
        self.name = "Haadthip HR Knowledge (Pipe)"
    ...
    async def pipe(
        ...
        await self._emit(__event_emitter__, "status", {
            "description": "🔍 กำลังค้นหาจากเอกสาร HR...", "done": False
        })
    ...
    async def _generate(
        ...
        source_hint = "ด้านล่างนี้คือเอกสาร HR ที่เกี่ยวข้อง:" if has_docs else (
            "⚠️ ไม่พบเอกสารที่เกี่ยวข้อง — ตอบตามความรู้ทั่วไป แต่แจ้งผู้ใช้"
        )

        system_prompt = f"""คุณคือ **ผู้ช่วยด้าน HR ของบริษัท หาดทิพย์ จำกัด (มหาชน)**
...
## คำแนะนำ
- ตอบเป็นภาษาไทย
- ยึดเนื้อหาจากเอกสาร HR — นโยบาย, แบบฟอร์ม, คู่มือ, ระเบียบ, ประกาศ
- ข้อมูลครอบคลุม: วันลา, สวัสดิการ, ค่าตอบแทน, ระเบียบปฏิบัติ, สิทธิพนักงาน
- อ้างอิง [ชื่อเอกสาร] ทุกครั้ง
- หากไม่มีข้อมูลเพียงพอ → บอกตามตรง และแนะนำให้ติดต่อฝ่าย HR โดยตรง"""
    ...
    async def get_models(self) -> list[dict]:
        return [{"id": "haadthip-hr-knowledge", "name": "Haadthip HR Knowledge (Pipe)"}]
