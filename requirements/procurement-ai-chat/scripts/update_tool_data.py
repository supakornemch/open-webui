...
TOOL_CODE = (
    ...
    '            matched_text += best\n'
    '\n'
    '        # Dimension scoring: exact number overlap (only when BOTH have dims)\n'
    '        dim_score = 1.0  # Default: neutral\n'
    '        if q_dims and n_dims:\n'
    '            q_set = set(q_dims)\n'
    '            n_set = set(n_dims)\n'
    '            overlap = q_set & n_set\n'
    ...
    '        """Find best matching item across all sheets. Filters out junk matches (score < 0.35)."""\n'
    '        MIN_SCORE = 0.35  # Below this = noise, not a real match\n'
    '        data = self._load()\n'
    '        best_score = 0.0\n'
    '        best_result = None\n'
    '        all_matches = []\n'
