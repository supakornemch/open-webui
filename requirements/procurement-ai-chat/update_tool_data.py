...
TOOL_CODE = (
    ...
    '        Separates text vs dimension tokens for scoring:\n'
    '        - Text tokens: proportional matching (70% weight)\n'
    '        - Dimension tokens: exact number match with swapped-dimension support (30% weight)\n'
    '        This prevents false matches where only words match but sizes are completely different.\n'
    '        """\n'
