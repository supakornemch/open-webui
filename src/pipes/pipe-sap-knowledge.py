"""
title: Haadthip SAP Knowledge (Pipe)
author: Haadthip
version: 1.0
required_open_webui_version: 0.1.0

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  Open WebUI Pipe — SAP HIP Manuals
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Install in Open WebUI:
  ...
  Then select "Haadthip SAP Knowledge (Pipe)" as the model
"""
...
class Pipe:
    ...
    def __init__(self):
        self.type = "pipe"
        self.id = "haadthip-sap-knowledge"
        self.name = "Haadthip SAP Knowledge (Pipe)"
    ...
    async def pipe(
        ...
        await self._emit(__event_emitter__, "status", {
            "description": "🔍 กำลังค้นหาจากคู่มือ SAP...", "done": False
        })
    ...
    async def _generate(
        ...
        source_hint = "ด้านล่างนี้คือคู่มือ SAP ที่เกี่ยวข้อง:" if has_docs else (
            "⚠️ ไม่พบเอกสารที่เกี่ยวข้อง — ตอบตามความรู้ทั่วไป แต่แจ้งผู้ใช้"
        )

        system_prompt = f"""คุณคือ **ผู้ช่วยด้าน SAP ของบริษัท หาดทิพย์ จำกัด (มหาชน)**
...
## คำแนะนำ
- ตอบเป็นภาษาไทย ยกเว้นศัพท์เทคนิคและ Tcode
- ยึดเนื้อหาจากคู่มือ SAP HIP
- ระบุ Tcode ให้ชัดเจนทุกครั้ง (เช่น mb52, /n/hip/fiar06, S_alr_87011964)
- ถ้าเป็นขั้นตอน → สรุปเป็นข้อๆ เรียงตามลำดับ
- เนื้อหาครอบคลุม: การดูสต๊อก, สินทรัพย์สาขา, การเงิน, รายงานต่างๆ
...
- หากไม่มีข้อมูลเพียงพอ → บอกตามตรง"""
    ...
    async def get_models(self) -> list[dict]:
        return [{"id": "haadthip-sap-knowledge", "name": "Haadthip SAP Knowledge (Pipe)"}]
